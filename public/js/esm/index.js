...
var twitterLogo = "data:image/png;base64,";

var facebookLogo = "data:image/png;base64,";
...
var Header = function Header() {
  return react.createElement("header", null, react.createElement("h1", null, "Learn the basics concepts about HTTP status code"), react.createElement("h3", null, "This is a list of HTTP status code that might be returned when a browser requests a service from a web service"));
};

var Options = function Options() {
  var windowOpen = function windowOpen(url, mode) {
    window.open(url, mode, "left=20,top=20,width=600,height=400,toolbar=0,resizable=1");
    return false;
  };

  var shareTwitter = function shareTwitter() {
    windowOpen("http://twitter.com/intent/tweet?text=A visual guide explaining HTTP status code. https://murillo94.github.io/know-http/", "twitterwindow");
  };

  var shareFacebook = function shareFacebook() {
    windowOpen("https://www.facebook.com/sharer.php?u=https://murillo94.github.io/know-http/", "fbwindow");
  };
...
var Codes = function Codes(_ref) {
  var codes = _ref.codes,
      digit = _ref.digit;
  return react.createElement(react.Fragment, null, codes.map(function (item) {
    return react.createElement("div", {
      key: item.value,
      className: "item-desc"
    ...
    }, item.value), react.createElement("div", null, item.reason)), react.createElement("div", {
      className: "collapsible-content"
    }, react.createElement("ul", null, react.createElement("li", null, item.description))));
  }));
};

var List = function List(_ref2) {
  var data = _ref2.data;
  return react.createElement("main", null, data.map(function (item, index) {
    return react.createElement("section", {
      key: item.digit,
      className: "item".concat(index + 1, "-area")
    }, react.createElement("p", null, item.digit, " ", item.reason), react.createElement(Codes, item));
  }));
};

var Status = function Status(_ref3) {
  var data = _ref3.data;
  return react.createElement(react.Fragment, null, react.createElement(Header, null), react.createElement(Options, null), react.createElement(List, {
    data: data
  }));
};

reactDom.render(react.createElement(Status, {
  data: data
