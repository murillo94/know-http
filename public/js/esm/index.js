...
var ListCodes = function ListCodes(_ref) {
...
var ListItems = function ListItems(_ref2) {
  ...
  return react.createElement("main", null, data.map(function (item, index) {
    ...
    }, react.createElement("p", null, item.digit, " ", item.reason), react.createElement(ListCodes, item));
  }));
};

var StatusList = function StatusList(_ref3) {
  var data = _ref3.data;
  return react.createElement(react.Fragment, null, react.createElement(HeaderTitle, null), react.createElement(HeaderButtons, null), react.createElement(ListItems, {
    data: data
  }));
};

reactDom.render(react.createElement(StatusList, {
  data: data
